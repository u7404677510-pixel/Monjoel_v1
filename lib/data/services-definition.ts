...
export const plomberieServices: Service[] = [
  ...
  // ============================================
  // NOUVEAUX SERVICES AHREFS - Plomberie
  // ============================================
  {
    slug: "debouchage-canalisation",
    name: "Débouchage canalisation",
    shortName: "Débouchage",
    description: "Débouchage de canalisation bouchée. Intervention rapide avec furet ou hydrocurage. Cuisine, salle de bain, évacuation.",
    icon: "Waves",
    priceFrom: 99,
    urgencyLevel: "high",
    keywords: ["débouchage canalisation", "canalisation bouchée", "déboucher canalisation", "hydrocurage", "furet canalisation"],
    metaDescription: "Débouchage canalisation à {city}. Intervention dès 99€. Furet ou hydrocurage. Résultat garanti, artisan vérifié.",
  },
  {
    slug: "urgence-24h",
    name: "Plombier urgence 24h",
    shortName: "Urgence 24h",
    description: "Plombier disponible 24h/24, 7j/7. Intervention urgente pour fuite, dégât des eaux, canalisation bouchée. Nuit, week-end, jours fériés.",
    icon: "Clock",
    priceFrom: 89,
    urgencyLevel: "high",
    keywords: ["plombier urgence", "urgence plomberie", "plombier 24h", "dépannage plomberie", "plombier nuit", "plombier dimanche"],
    metaDescription: "Plombier urgence 24h/24 à {city}. Intervention dès 89€. Nuit, week-end, jours fériés. Prix fixe garanti.",
  },
  {
    slug: "recherche-fuite",
    name: "Recherche de fuite",
    shortName: "Recherche fuite",
    description: "Recherche de fuite d'eau non visible. Détection par caméra thermique, gaz traceur, écoute acoustique. Sans destruction.",
    icon: "Search",
    priceFrom: 149,
    urgencyLevel: "medium",
    keywords: ["recherche fuite", "detection fuite eau", "fuite cachée", "fuite invisible", "recherche fuite eau", "entreprise recherche fuite"],
    metaDescription: "Recherche de fuite à {city}. Détection dès 149€. Caméra thermique, sans destruction. Rapport pour assurance.",
  },
  {
    slug: "ballon-eau-chaude",
    name: "Ballon eau chaude",
    shortName: "Ballon",
    description: "Installation et remplacement de ballon d'eau chaude (cumulus). Toutes capacités : 50L à 300L. Électrique ou thermodynamique.",
    icon: "Thermometer",
    priceFrom: 129,
    urgencyLevel: "medium",
    keywords: ["ballon eau chaude", "cumulus", "chauffe eau electrique", "remplacement cumulus", "fuite ballon eau chaude"],
    metaDescription: "Ballon eau chaude à {city}. Installation ou remplacement dès 129€. Toutes capacités. Artisan qualifié.",
  },
  {
    slug: "chaudiere-panne",
    name: "Chaudière en panne",
    shortName: "Chaudière",
    description: "Dépannage chaudière gaz, fioul ou électrique. Diagnostic et réparation. Toutes marques : Saunier Duval, Chappée, De Dietrich.",
    icon: "Flame",
    priceFrom: 119,
    urgencyLevel: "high",
    keywords: ["chaudière panne", "dépannage chaudière", "chaudière ne démarre plus", "fuite chaudière", "chauffage en panne"],
    metaDescription: "Chaudière en panne à {city} ? Dépannage dès 119€. Diagnostic inclus. Toutes marques. Intervention rapide.",
  },
  {
    slug: "debouchage-wc",
    name: "Débouchage WC",
    shortName: "WC bouchés",
    description: "Débouchage WC professionnel. Intervention rapide et propre. WC bouché, eau qui remonte, évacuation lente.",
    icon: "ShowerHead",
    priceFrom: 79,
    urgencyLevel: "high",
    keywords: ["débouchage wc", "wc bouché", "toilettes bouchées", "déboucher toilettes", "wc bouché que faire", "tarif plombier wc bouché"],
    metaDescription: "WC bouchés à {city} ? Débouchage express dès 79€. Intervention 30 min. Prix fixe, sans surprise.",
  },
  {
    slug: "tarifs",
    name: "Tarifs plombier",
    shortName: "Tarifs",
    description: "Grille tarifaire complète et transparente. Prix fixes annoncés avant intervention. Zéro surprise, zéro arnaque.",
    icon: "Euro",
    priceFrom: 69,
    urgencyLevel: "low",
    keywords: ["tarif plombier", "prix plombier", "cout plombier", "plombier pas cher", "tarif horaire plombier", "prix intervention plombier"],
    metaDescription: "Tarifs plombier transparents. Prix fixe dès 69€. Fuite, débouchage, chauffe-eau. Devis gratuit.",
  },
  // ============================================
  // SERVICES SUPPLÉMENTAIRES - Scaling Plomberie
  // ============================================
  {
    slug: "evier-bouche",
    name: "Évier bouché",
    shortName: "Évier",
    description: "Débouchage d'évier cuisine ou salle de bain. Intervention rapide, méthode professionnelle. Résultat garanti.",
    icon: "Waves",
    priceFrom: 79,
    urgencyLevel: "high",
    keywords: ["évier bouché", "déboucher évier", "évier cuisine bouché", "évier ne s'écoule plus", "débouchage évier"],
    metaDescription: "Évier bouché à {city} ? Débouchage express dès 79€. Cuisine ou salle de bain. Résultat garanti, artisan vérifié.",
  },
  {
    slug: "chasse-eau",
    name: "Réparation chasse d'eau",
    shortName: "Chasse d'eau",
    description: "Réparation ou remplacement de mécanisme de chasse d'eau. Chasse qui fuit, qui coule en permanence, bouton cassé.",
    icon: "Droplets",
    priceFrom: 69,
    urgencyLevel: "medium",
    keywords: ["chasse d'eau", "réparation chasse eau", "chasse eau qui fuit", "mécanisme wc", "chasse eau qui coule"],
    metaDescription: "Chasse d'eau qui fuit à {city} ? Réparation dès 69€. Mécanisme, flotteur, bouton. Intervention rapide.",
  },
  {
    slug: "fuite-tuyau",
    name: "Fuite tuyau / canalisation",
    shortName: "Tuyau percé",
    description: "Réparation de tuyau percé ou fissuré. Cuivre, PVC, PER. Intervention urgente, remplacement si nécessaire.",
    icon: "AlertTriangle",
    priceFrom: 99,
    urgencyLevel: "high",
    keywords: ["fuite tuyau", "tuyau percé", "fuite canalisation", "réparation tuyau", "tuyau qui fuit"],
    metaDescription: "Tuyau percé à {city} ? Réparation urgente dès 99€. Cuivre, PVC, PER. Intervention rapide, artisan qualifié.",
  },
  {
    slug: "installation-wc",
    name: "Installation WC",
    shortName: "Pose WC",
    description: "Installation ou remplacement de WC. WC classique, suspendu, broyeur. Pose complète avec raccordement.",
    icon: "ShowerHead",
    priceFrom: 149,
    urgencyLevel: "low",
    keywords: ["installation wc", "pose wc", "remplacement toilettes", "wc suspendu", "installer toilettes"],
    metaDescription: "Installation WC à {city}. Pose complète dès 149€. WC classique ou suspendu. Artisan qualifié, devis gratuit.",
  },
  {
    slug: "groupe-securite",
    name: "Groupe de sécurité",
    shortName: "Groupe sécu",
    description: "Remplacement de groupe de sécurité chauffe-eau. Groupe qui fuit, goutte à goutte, calcaire. Intervention rapide.",
    icon: "Shield",
    priceFrom: 89,
    urgencyLevel: "medium",
    keywords: ["groupe sécurité", "groupe sécurité chauffe-eau", "groupe sécurité qui fuit", "remplacement groupe sécurité"],
    metaDescription: "Groupe de sécurité qui fuit à {city} ? Remplacement dès 89€. Chauffe-eau, cumulus. Intervention rapide.",
  },
  {
    slug: "lavabo-bouche",
    name: "Lavabo bouché",
    shortName: "Lavabo",
    description: "Débouchage lavabo et siphon. Évacuation lente, eau stagnante. Méthode professionnelle sans produit chimique.",
    icon: "Waves",
    priceFrom: 69,
    urgencyLevel: "medium",
    keywords: ["lavabo bouché", "siphon bouché", "déboucher lavabo", "lavabo ne se vide pas", "débouchage lavabo"],
    metaDescription: "Lavabo bouché à {city} ? Débouchage dès 69€. Siphon, évacuation lente. Intervention propre et rapide.",
  },
];
