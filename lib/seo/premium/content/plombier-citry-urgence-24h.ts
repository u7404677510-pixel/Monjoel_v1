...
export const content: PremiumPageContent = {
  ...
  metaTitle: "Plombier urgence Citry 24h/24 — dès 89€, 0 majoration",
  metaDescription:
    "Urgence plomberie à Citry (77730) : fuite, WC, chauffe-eau. Artisan dès 89€ TTC, prix fixe annoncé avant, 0 majoration nuit & week-end. 01 41 69 10 08.",
  h1: "Urgence plomberie à Citry (77730) : survivre à une fuite dans un village de 941 habitants, sans paniquer ni se faire plumer",
  introParagraph: `### Il est 23h47, un samedi, et l'eau coule là où elle ne devrait pas
...
Moi c'est Camille, étudiante en master d'architecture, blogueuse de galères locatives, et petite-fille officielle de la vallée de la Marne. Cette page, c'est le plan que j'aurais voulu avoir : les bons gestes des dix premières minutes, les quatre urgences typiques du coin (gel compris, on en reparle), les vrais prix — **dès 89€ TTC chez Joël, prix fixe annoncé AVANT l'intervention, 0 majoration nuit & week-end, au 01 41 69 10 08** — et la méthode pour repérer les pièges avant de signer quoi que ce soit en pyjama dans la cuisine.`,
  sections: [
    {
      anchor: "citry-village-urgence-plomberie-pas-comme-paris",
      title: "Une urgence plomberie à Citry n'est pas une urgence parisienne (et il faut le comprendre avant d'appeler)",
      body: `Commençons par planter le décor, parce que le contexte change tout — y compris la façon dont on se fait arnaquer.
...
C'est exactement la faille qu'exploite l'arnaque au dépannage rural : tu es loin, tu n'as pas d'alternative visible, il est tard, et tu as de l'eau par terre. Toute la suite de cette page sert à neutraliser ces quatre leviers un par un. Spoiler : ça commence par savoir fermer une vanne, et ça finit par exiger un prix total annoncé avant — ce que Joël fait par principe, dès 89€ TTC, au 01 41 69 10 08, à toute heure et sans majoration.`,
    ...
    {
      anchor: "protocole-10-minutes-couper-contenir-filmer",
      title: "Mon protocole des dix premières minutes : couper, contenir, filmer",
      body: `Ce protocole, je l'ai rodé dans la maison de ma grand-mère, et il tient en trois verbes. L'ordre compte.
...
**5. Prépare ton appel.** Avant de composer le numéro, note trois choses : eau claire ou chaude ? où exactement (cave, cuisine, plafond de l'étage) ? depuis quand ? Avec ces trois infos, un vrai professionnel peut t'annoncer un **prix ferme au téléphone** — c'est tout l'intérêt du modèle Joël : tu décris, on te dit le tarif TTC (dès 89€ pour une urgence), et ce tarif ne bouge plus. Celui qui te répond « on verra sur place », lui, prépare déjà la deuxième page de la facture.`,
    ...
    {
      anchor: "quatre-urgences-classiques-vallee-marne",
      title: "Fuite, gel, ballon, refoulement : les quatre urgences que la vallée de la Marne connaît par cœur",
      body: `Après des années de galères personnelles et de récits de voisins de ma grand-mère, je peux te dresser le portrait-robot des urgences plomberie du secteur. Il y en a quatre, et chacune a ses pièges.
...
Le point commun des quatre ? Aucune ne se résout en s'acharnant seul à 1h du matin. La bonne séquence, c'est : sécuriser (section précédente), puis appeler en connaissant le juste prix (section suivante).`,
    ...
    {
      anchor: "vrai-prix-urgence-plombier-citry-anti-arnaque",
      title: "Le vrai prix d'une urgence à Citry — et l'anatomie du « 49€ » qui finit à 900",
      body: `Parlons argent, frontalement, parce que c'est là que tout se joue — et que c'est là que j'ai failli me faire avoir.
...
Face à ça, le modèle Joël est d'une simplicité presque vexante pour les arnaqueurs : **un prix fixe, annoncé au téléphone, avant l'intervention — dès 89€ TTC pour une urgence plomberie à Citry — et 0 majoration nuit, week-end ou jour férié.** Le 89€ de 15h reste le 89€ de 3h du matin un dimanche. Pas de « zone éloignée », pas de supplément surprise : le déplacement jusqu'à la vallée de la Marne est compris dans le tarif annoncé. C'est le principe inverse de l'appât : le chiffre qu'on te donne est celui que tu paieras. Le tableau des prix réels, un peu plus bas sur cette page, te donne les fourchettes du marché pour comparer — compare, justement. La transparence ne craint pas la comparaison.`,
    ...
    {
      anchor: "joel-citry-appel-3h-du-matin",
      title: "Concrètement : ce qui se passe quand tu appelles Joël à 3h du matin depuis Citry",
      body: `Je te déroule le film, étape par étape, parce que savoir à quoi s'attendre enlève la moitié du stress.
...
**Et le même prix, vraiment, à toute heure.** J'insiste une dernière fois parce que c'est LE point qui change la psychologie de l'urgence : pas de majoration de nuit, pas de majoration de week-end, pas de majoration de jour férié. Quand tu sais ça, tu n'as plus aucune raison d'attendre 8h du matin en épongeant toutes les vingt minutes « pour éviter le tarif de nuit ». La fuite, elle, ne fait pas de pause — autant l'arrêter au prix de jour.`,
    ...
    {
      anchor: "qui-paie-locataire-proprio-residence-secondaire",
      title: "Qui paie quoi : locataire, propriétaire, résidence secondaire (et le réflexe assurance qui sauve)",
      body: `Dernière pièce du puzzle, et pas la moindre : une fois l'eau arrêtée et la facture en main, qui sort le portefeuille ? La réponse tient en une logique simple : **on regarde la cause, pas le symptôme.**
...
**Mon mode d'emploi en quatre lignes :** je documente la cause (vidéo datée) ; je sécurise ; je préviens proprio ou assureur avant d'engager des frais quand ce n'est pas une urgence absolue — et quand c'en est une, je fais intervenir d'abord et je transmets le dossier ensuite ; je garde précieusement la facture détaillée. Avec un prix annoncé d'avance et une facture qui nomme la cause, tu transformes une galère de plomberie en simple dossier administratif. C'est nettement moins romantique qu'un village AOP au bord de la Marne, mais crois-moi : le jour J, c'est ça qui te sauve la soirée — et le budget.`,
  ...
  vraisPrix: [
    {
      service: "Urgence fuite d'eau à Citry (mise en sécurité comprise)",
      prixJoel: 89,
      prixArnaqueur: "49€ annoncé → 380-900€ facturé (avec « frais de zone éloignée »)",
      pourquoi:
    ...
    {
      service: "WC bouché en urgence (bourg, écarts, Pisseloup)",
      prixJoel: 79,
      prixArnaqueur: "29€ annoncé → 290-650€ facturé",
      pourquoi:
    ...
    {
      service: "Chauffe-eau ou ballon en panne (eau dure du secteur)",
      prixJoel: 109,
      prixArnaqueur: "59€ annoncé → 450-1200€ facturé (remplacement « obligatoire »)",
      pourquoi:
    ...
    {
      service: "Dégât des eaux : mise en sécurité + constat exploitable",
      prixJoel: 99,
    ...
    {
      service: "Recherche de fuite non destructive (réseaux anciens, fuite invisible)",
      prixJoel: 149,
      prixArnaqueur: "69€ annoncé → 600-1500€ facturé (murs ouverts « au hasard »)",
      pourquoi:
  ...
  faqLocale: [
    {
      question:
        "Un plombier peut-il vraiment arriver en pleine nuit à Citry, à plus d'une heure de Paris ?",
      answer:
    ...
    {
      question:
        "Mes canalisations ont gelé dans ma maison près des bords de Marne : je fais quoi en attendant le plombier ?",
      answer:
        "Coupe la vanne générale immédiatement (le pire arrive au dégel, quand le tuyau fendu se met à fuir), ouvre les robinets en aval pour décompresser, et réchauffe doucement la zone : sèche-cheveux, chiffons tièdes, chauffage de la pièce. Jamais de flamme ni de chalumeau sur un tuyau gelé — risque d'éclatement et d'incendie. Si l'eau revient avec une fuite, laisse la vanne fermée et appelle : l'intervention d'urgence démarre à 89€ TTC, prix annoncé avant.",
    },
    {
      question: "L'eau de Citry est-elle calcaire ? C'est pour ça que mon ballon fatigue ?",
      answer:
        "Comme l'essentiel de la Seine-et-Marne, le secteur est alimenté par une eau réputée dure — tu peux consulter la fiche officielle de la commune sur orobnat.sante.gouv.fr (contrôle sanitaire de l'ARS, données publiques). Le calcaire entartre résistances et groupes de sécurité, ce qui raccourcit la vie des chauffe-eau. Avant d'accepter un remplacement complet « urgent », fais diagnostiquer : un détartrage ou une résistance changée (dépannage dès 109€ TTC chez Joël) suffit souvent.",
    },
    {
      question:
        "J'ai une résidence secondaire à Citry et je découvre une fuite en arrivant le week-end : qui paie ?",
      answer:
        "D'abord on coupe, on photographie et on fait intervenir pour stopper les dégâts — dès 89€ TTC, prix annoncé avant, même le samedi soir. Ensuite, tout dépend de ton contrat d'assurance : beaucoup comportent une clause gel ou inoccupation qui conditionne l'indemnisation à des mesures hivernales (vidange, coupure d'eau, maintien hors gel). Déclare le sinistre sous 5 jours ouvrés avec la facture Joël mentionnant la cause. Et avant l'hiver prochain : vanne fermée + purge avant de quitter la maison.",
    },
    {
      question:
        "Ma maison n'est pas au tout-à-l'égout : le débouchage en urgence, c'est différent avec une fosse ?",
      answer:
        "Oui, sur un point crucial : zéro produit chimique. Les déboucheurs corrosifs détruisent la flore bactérienne qui fait fonctionner l'assainissement individuel, et tu transformes un bouchon en panne de fosse complète. Signale ton mode d'assainissement dès l'appel : l'artisan adapte sa méthode (furet, intervention mécanique) et vérifie que le refoulement ne vient pas de la fosse pleine — auquel cas c'est une vidange par un agréé qu'il te faut, pas un débouchage. Le diagnostic honnête évite de payer la mauvaise prestation.",
    },
    {
      question:
  ...
  temoignages: [
    {
      auteur: "Élodie R.",
      quartierOuRue: "Le bourg, près de l'église Saint-Ponce",
      date: "2026-01-12",
      rating: 5,
      serviceRendered: "Canalisation gelée puis fuite au dégel",
      texte:
    ...
    },
    {
      ...
      quartierOuRue: "Hameau de Pisseloup",
      date: "2026-03-28",
      rating: 5,
      serviceRendered: "Ballon d'eau chaude en panne un samedi soir",
      texte:
    ...
    {
      auteur: "Julien T.",
      quartierOuRue: "Côté coteaux, au-dessus des vignes",
      date: "2026-05-09",
      rating: 4,
      serviceRendered: "Fuite sur raccord cuivre dans la cave",
      texte:
  ...
  internalLinks: [
    ...
    },
    {
      ...
      anchor: "la grille tarifaire transparente, identique jour et nuit",
    },
    {
      url: "/plombier/la-ferte-gaucher/debouchage-canalisation",
      anchor: "débouchage de canalisation à La Ferté-Gaucher",
      contexte: "Le même réseau intervient dans tout l'est de la Seine-et-Marne.",
    },
    {
      url: "/electricien/meaux",
      anchor: "électricien à Meaux : diagnostic et dépannage",
    },
    {
      url: "/serrurier/meaux",
      anchor: "serrurier à Meaux : ouverture de porte sans casse",
    },
  ],
  tags: [
    "citry",
