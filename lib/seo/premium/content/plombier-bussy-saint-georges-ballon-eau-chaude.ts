...
export const content: PremiumPageContent = {
  ...
  metaTitle: "Ballon eau chaude Bussy-St-Georges : dès 129€, 24h/24",
  metaDescription:
    "Ballon d'eau chaude HS à Bussy-Saint-Georges ? Dépannage dès 129€ TTC, prix fixe annoncé avant, 0 majoration nuit & week-end. 01 41 69 10 08, 24h/24.",
  h1: "Ballon d'eau chaude en panne à Bussy-Saint-Georges : la ville est jeune, vos cumulus non (et le prix se dit avant, pas après)",
  introParagraph: `Je m'appelle Yannick Chen. Je tiens un restaurant rue de la Roquette et deux boutiques dans le 20e, et j'ai présidé pendant des années une association de commerçants. Mon rapport à l'eau chaude n'a rien de sentimental : quand elle s'arrête, je perds de l'argent. Un bac de plonge glacial à 18h45, un service qui démarre dans une heure, et tout vacille.
...
Cette page, c'est ma façon de tenir le comptoir pour les Buxangeorgiens. Ce que le calcaire fait vraiment à votre ballon, ce que vous pouvez vérifier vous-même en cinq minutes, quand réparer, quand remplacer, et comment Joël travaille ici : **dépannage dès 129€ TTC, prix fixe annoncé avant intervention, 0 majoration nuit & week-end**, au **01 41 69 10 08**, 24h/24. Chez moi, on annonce le prix du plat avant de servir. Pour un dépannage, je n'accepte rien de moins.`,
  sections: [
    {
      anchor: "bussy-trois-vagues-de-construction-cumulus",
      title: "Une ville bâtie en trois vagues — des ballons qui vieillissent par résidences entières",
      body: `Pour comprendre pourquoi les pannes de ballon explosent à Bussy-Saint-Georges, il faut regarder le calendrier de la ville. Et ce calendrier, il est unique en Île-de-France.
...
Le tartre, c'est comme les charges fixes d'un commerce : invisible au quotidien, mortel sur l'année. On ne le supprime pas, on le gère.`,
    ...
    {
      anchor: "diagnostic-express-panne-ballon-bussy",
      title: "Douche froide ce matin ? Les cinq vérifications qui prennent moins de temps qu'un café",
      body: `Avant de décrocher votre téléphone, faites ce que je fais dans mes boutiques quand un équipement tombe : un tour du propriétaire, méthodique, cinq minutes chrono. Dans un cas sur trois, vous n'aurez besoin de personne. Et dans les autres cas, vous saurez décrire la panne — ce qui change tout au téléphone.
...
Dernier réflexe, le plus rentable de tous : **photographiez**. La plaque signalétique (marque, capacité, année), le tableau, la fuite éventuelle. Trente secondes de photos, c'est un diagnostic téléphonique précis, un prix juste annoncé d'emblée, et zéro place pour le baratin une fois l'artisan sur place. Au 01 41 69 10 08, décrivez ce que vous avez vu : le tarif vous est donné avant que quiconque monte chez vous.`,
    ...
    {
      anchor: "reparer-ou-remplacer-ballon-decision",
      title: "Réparer ou remplacer ? Tranchez comme un gestionnaire, pas sous la panique",
      body: `Dans le commerce, on apprend vite à ne jamais décider un prix sous pression. Une panne d'eau chaude, c'est pareil : la pire décision est celle qu'on prend en grelottant. Voici ma grille, simple, celle que j'applique à mon propre matériel.
...
Un mot pour mes confrères commerçants de Bussy — les restaurateurs et salons du centre-ville, les artisans des zones d'activités : pour nous, l'eau chaude n'est pas un confort, c'est une **obligation d'hygiène**. Une plonge à froid, un bac de shampoing glacial, et c'est l'activité qui s'arrête. Faites le calcul que je fais : un samedi soir à 80 couverts et 35€ de ticket moyen, chaque heure de fermeture se chiffre en centaines d'euros. À ce tarif-là, le « dépanneur pas cher » qui met quatre heures à venir et triple sa facture est le choix le plus coûteux du marché. Un prix fixe, une arrivée rapide, une facture propre avec SIRET pour l'assurance multirisque pro : voilà ce qui protège un commerce. Et un foyer, c'est pareil — la seule différence, c'est que personne ne vous rembourse les douches froides.`,
    ...
    {
      anchor: "arnaques-ballon-eau-chaude-bussy",
      title: "Le théâtre de la fausse urgence : comment 30€ de pièce deviennent 1 400€ de facture",
      body: `Le dépannage de ballon d'eau chaude est l'un des terrains favoris des factures gonflées, et Bussy coche toutes les cases du marché idéal pour ces gens-là : parc vieillissant, habitants pressés, pavillons faciles à tracter. Je vous décris la mécanique, pièce par pièce, comme on me l'a jouée et comme on la jouera chez vous si vous ne la connaissez pas.
...
Mon dernier conseil de comptoir : préparez le numéro *avant* la panne. Le pire moment pour choisir un dépanneur, c'est sous la douche froide. Notez le **01 41 69 10 08** quelque part — sur le frigo, dans le téléphone — comme vous noteriez le numéro de votre assureur. Le jour J, vous appellerez quelqu'un que vous avez choisi à tête reposée, avec un prix qui ne bougera pas. C'est toute la différence entre subir une panne et la gérer.`,
  ...
  vraisPrix: [
    {
      service: "Dépannage ballon d'eau chaude (thermostat, résistance, contacteur)",
      prixJoel: 129,
    ...
    {
      service: "Remplacement du groupe de sécurité",
      prixJoel: 89,
    ...
    {
      service: "Détartrage complet + contrôle d'anode",
      prixJoel: 169,
      prixArnaqueur: "59€ annoncé → 400-700€ facturé",
      pourquoi:
    ...
    {
      service: "Remplacement ballon électrique fourni-posé",
      prixJoel: 590,
      prixArnaqueur: "ballon sans marque → 1 800-2 600€ facturé",
      pourquoi:
    ...
    {
      service: "Panne d'eau chaude un dimanche, la nuit ou un jour férié",
      prixJoel: 129,
      prixArnaqueur: "69€ annoncé → 500-1 200€ avec « majoration urgence »",
      pourquoi:
  ...
  faqLocale: [
    {
      question:
        "Mon ballon date de la livraison de ma résidence près de la gare RER, au début des années 2000 : je dois le changer même s'il fonctionne encore ?",
      answer:
    ...
    {
      question: "L'eau de Bussy-Saint-Georges est-elle vraiment plus calcaire qu'ailleurs ?",
      answer:
        "Elle est franchement dure : les analyses du contrôle sanitaire de mars 2026 mesuraient autour de 28 °f (28,6 °f mesurés en mars 2026) selon le point du réseau (SMAEP de la région de Lagny, exploité par Veolia), alors qu'une eau est dite dure dès 15 °f. Elle reste parfaitement potable — aucune limite réglementaire dépassée. Mais pour un ballon, ça veut dire entartrage accéléré : résistance gainée de calcaire, groupe de sécurité grippé, anode à surveiller. D'où l'intérêt d'un détartrage tous les deux à trois ans ici.",
    },
    {
      question:
        "J'habite à l'écoquartier du Sycomore et mon eau chaude vient du réseau de chaleur : Joël peut intervenir ?",
      answer:
        "Ça dépend d'où vient la panne. Au Sycomore, une partie des programmes produit l'eau chaude collectivement via le réseau de chaleur biomasse : si tout l'immeuble est à froid, c'est l'affaire du syndic et de l'exploitant du réseau. En revanche, tout ce qui est individuel — ballon électrique ou thermodynamique d'appoint, mitigeurs, fuites sur votre installation privative — relève d'un plombier, et Joël intervient au prix annoncé. Si votre logement a moins de dix ans, vérifiez aussi la garantie du promoteur avant de payer quoi que ce soit.",
    },
    {
      question:
        "Plus d'eau chaude un dimanche soir aux Cent Arpents : vous venez vraiment sans majoration ?",
      answer:
        "Oui, et c'est tout l'intérêt. Le réseau Joël intervient à Bussy 24h/24, 7j/7, dimanches et fériés compris, sans aucune majoration nuit ou week-end : le dépannage reste dès 129€ TTC, annoncé au téléphone avant le déplacement. Les artisans couvrent tout l'est francilien (Lagny, Torcy, Chelles, Val d'Europe), donc comptez en général 20 à 40 minutes. Appelez le 01 41 69 10 08 en décrivant ce que vous avez vérifié — disjoncteur, marche forcée, groupe de sécurité —, le tarif tombe tout de suite.",
    },
    {
      question: "Je suis locataire dans le vieux bourg : le dépannage du cumulus, c'est pour moi ou pour le propriétaire ?",
      answer:
        "La ligne de partage est simple : l'entretien courant revient au locataire (manœuvre du groupe de sécurité, détartrage périodique, remplacement des petites pièces d'usure comme les joints), tandis que la vétusté revient au propriétaire — un ballon en fin de vie, une cuve percée, une résistance morte d'usure se remplacent à ses frais. Documentez la panne (photos, date), prévenez le propriétaire avant de commander l'intervention sauf urgence réelle, et gardez la facture détaillée de Joël : la cause notée dessus dit qui doit payer.",
    },
    {
      question: "Marche forcée enclenchée, toujours pas d'eau chaude après une nuit : c'est quoi le verdict probable ?",
      answer:
        "Si la marche forcée (position I du contacteur) ne donne rien après plusieurs heures, le contacteur est hors de cause : on s'oriente vers la sécurité thermique déclenchée, une résistance morte — très courant en eau à 28 °f — ou un thermostat en défaut. Si en plus le disjoncteur du ballon saute, c'est quasi signé. Tout ça se répare en une visite, dès 129€ TTC annoncés avant au 01 41 69 10 08. Seule exception : de l'eau au sol sous la cuve, et là on parle remplacement, chiffré par écrit avant accord.",
    },
  ],
  temoignages: [
    {
      auteur: "Karim L.",
      quartierOuRue: "Centre-ville, à deux pas de la gare RER A",
      date: "2026-02-11",
      rating: 5,
      serviceRendered: "Dépannage ballon — contacteur heures creuses",
      texte:
    ...
    {
      auteur: "Nathalie P.",
      quartierOuRue: "Les Cent Arpents",
      date: "2026-04-26",
      rating: 5,
      serviceRendered: "Remplacement ballon 200 L (cuve percée)",
      texte:
    ...
    {
      auteur: "Étienne R.",
      quartierOuRue: "Vieux bourg",
      date: "2026-01-08",
      rating: 4,
      serviceRendered: "Groupe de sécurité + détartrage",
      texte:
  ...
  internalLinks: [
    {
      ...
      anchor: "plombier à Chelles, de l'autre côté de la Marne",
      contexte: "Le réseau couvre aussi les communes voisines du nord.",
    },
    {
      url: "/plombier/noisiel/fuite-eau",
      anchor: "fuite d'eau à Noisiel, sur la même ligne du RER A",
    },
    {
      url: "/plombier/chauffe-eau-panne",
      anchor: "panne de chauffe-eau : le service en intervention rapide 24h/24",
    },
    {
