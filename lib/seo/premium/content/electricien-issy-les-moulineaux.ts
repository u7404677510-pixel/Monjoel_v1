  ...
  faqLocale: [
    {
      ...
      answer:
        "Très probablement parce que le différentiel qui protège le circuit cuisson est de type AC (sensible aux courants alternatifs uniquement), alors que la NF C 15-100 (auparavant amendement A5, désormais **nouvelle série publiée par AFNOR le 23 août 2024**) impose un type A (sensible aussi aux courants continus pulsés) pour les plaques induction modernes — la nouvelle série introduisant en plus le **DDR type F** recommandé pour les circuits à variateur de fréquence. Sur les premiers tableaux RT2012 livrés 2013-2017, beaucoup d'installateurs ont posé du type AC par défaut. Quand vous branchez une plaque induction avec onduleur, le module type AC voit des courants continus qu'il ne sait pas analyser correctement et déclenche pour rien — ou pire, ne déclenche pas en cas de défaut réel. Joël remplace le module par un type A ou F pour 129 € TTC, prix annoncé avant.",
    },
    {
