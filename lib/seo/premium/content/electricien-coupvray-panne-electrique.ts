...
export const content: PremiumPageContent = {
  ...
  metaTitle: "Panne électrique Coupvray : électricien 24h/24 dès 89€",
  metaDescription:
    "Panne électrique à Coupvray ? Diagnostic dès 89€ TTC, prix fixe annoncé avant, 0 majoration nuit & week-end. Électricien en 20-30 min : 01 41 69 10 08.",
  h1: "Panne électrique à Coupvray (77700) : le protocole complet, du village de Louis Braille aux Trois Ormes",
  introParagraph: `### Pourquoi un ancien gendarme écrit sur les pannes de courant
...
Ma méthode tient en trois mots : procédure, prix, vigilance. Le réseau Joël intervient à Coupvray **24h/24** avec un principe non négociable : le **prix fixe est annoncé avant l'intervention** — à partir de **89€ TTC** pour un diagnostic de panne, déplacement compris, **0 majoration** de nuit, de week-end ou de jour férié. Le numéro : **01 41 69 10 08**. Tout ce qui suit vous donne les moyens de vérifier que ce que j'avance est exact.`,
  sections: [
    {
      anchor: "protocole-coupure-courant-coupvray",
      title: "Coupure de courant : le réflexe en quatre temps, comme une levée de doute",
      body: `Un disjoncteur qui tombe n'est pas une catastrophe. C'est un message. Encore faut-il le lire dans le bon ordre. Voici la séquence que j'enseigne en formation de sûreté résidentielle, transposée à l'électricité.
...
**Quatrième temps : décider, calmement.** Trois signaux imposent l'appel immédiat à un professionnel : odeur de brûlé ou trace de chauffe au tableau ; protection qui retombe systématiquement après réarmement ; grésillement ou étincelle audible. Dans ces trois cas, coupez le général et appelez. À l'inverse, trois situations tolèrent d'attendre le lendemain : panne limitée à un appareil identifié et débranché, circuit secondaire isolé sans enjeu, défaut disparu une fois le coupable écarté. Dans tous les cas, l'exigence reste la même : un prix ferme annoncé au téléphone, avant le déplacement. Chez Joël, le diagnostic de panne à Coupvray est à **89€ TTC, jour et nuit, 0 majoration** — **01 41 69 10 08**. Vous savez où vous allez avant que quiconque sonne à votre porte.`,
    ...
    {
      anchor: "bati-coupvray-village-briard-trois-ormes",
      title: "Deux Coupvray, deux parcs électriques : la ferme briarde et le PassivHaus",
      body: `Une commune de 8,1 km² pour 1 396 logements (INSEE 2022) : Coupvray reste un village. Mais un village coupé en deux par soixante ans d'histoire constructive, et l'électricien qui intervient ici change littéralement de siècle d'une rue à l'autre.
...
**Ce que cette dualité change pour vous.** D'abord, le taux de logements vacants — 13,9 % en 2022, inhabituel pour une commune de ce profil — raconte les livraisons en cours dans les ZAC : un parc neuf en rodage, où les défauts de jeunesse se traitent par la garantie, pas par le portefeuille. Ensuite, **82,1 % des ménages de Coupvray sont propriétaires de leur résidence principale** (INSEE 2022) : ici, pas de syndic ni de bailleur derrière qui s'abriter — la décision et la facture vous appartiennent en direct. Raison de plus pour exiger un diagnostic honnête plutôt qu'un devis de remplacement complet dégainé en trois minutes. Un professionnel sérieux commence par identifier dans quel « Coupvray » il se trouve : on ne diagnostique pas une ferme briarde rénovée par strates comme un T4 PassivHaus livré l'an dernier.`,
    ...
    {
      anchor: "causes-panne-electrique-coupvray",
      title: "Cinq origines de panne, classées par fréquence — et celle qui ne dépend pas de vous",
      body: `En trente et un ans de carrière, j'ai appris à me méfier des explications exotiques. Les pannes électriques résidentielles, comme les cambriolages, suivent des schémas récurrents. Cinq origines couvrent l'écrasante majorité des dossiers. Je les classe par fréquence décroissante, façon compte rendu.
...
**La cause zéro : le réseau.** Coupvray reste une commune de frange urbaine, entre plateau briard et canal. Orage d'été, coup de vent, incident sur le poste de distribution : la coupure générale de secteur existe et ne relève ni de vous ni d'un électricien privé. Vérification en trente secondes — voisins, éclairage public, site d'Enedis — avant tout appel payant. Un professionnel honnête vous posera d'ailleurs ces questions au téléphone avant de se déplacer ; c'est même un bon test de sa probité.`,
    ...
    {
      anchor: "panne-electrique-surete-domicile",
      title: "Une maison sans courant est une maison vulnérable : le regard d'un ancien enquêteur",
      body: `On me demande parfois pourquoi un ancien enquêteur cambriolages s'intéresse aux pannes électriques. Réponse de terrain : parce qu'une coupure prolongée modifie la vulnérabilité d'un domicile, et que personne ne prévient les habitants.
...
**Et au retour du courant.** Après une coupure longue, réenclenchez par étapes : le disjoncteur général, puis les rangées, puis les gros consommateurs un par un. Vous éviterez l'appel de courant qui fait retomber le général — et si la panne avait une cause interne, vous identifierez immédiatement le circuit fautif. Méthode, toujours. C'est elle qui fait la différence entre un incident maîtrisé et une soirée de panique facturée au prix fort par le premier venu.`,
    ...
    {
      anchor: "arnaque-depannage-electrique-coupvray",
      title: "Dépanneurs voyous : le mode opératoire vu côté procédure, et les quatre contrôles qui les stoppent",
      body: `Vingt-deux ans en section de recherches m'ont fait croiser le dépannage frauduleux sous toutes ses coutures — à l'époque surtout côté serrurerie après effraction, aujourd'hui, et souvent avec les mêmes équipes, côté électricité. Le mode opératoire est d'une stabilité remarquable. Je vous le restitue tel qu'il apparaît dans les dossiers.
...
**Si le mal est fait, dans l'ordre.** 1° Conservez tout : facture, devis, photographies du tableau avant et après, échanges écrits. 2° Signalez sur signal.conso.gouv.fr — chaque signalement alimente les enquêtes de la DGCCRF. 3° Hors urgence avérée et signée, le délai de rétractation de 14 jours s'applique aux prestations conclues à domicile : courrier recommandé sans attendre. 4° Paiement par carte : demandez la procédure de chargeback à votre banque. 5° Déposez plainte auprès de votre brigade de gendarmerie — oui, même pour 400€. C'est l'accumulation des plaintes qui permet de remonter les réseaux ; trente et un ans de métier me placent bien pour l'affirmer.`,
    ...
    {
      anchor: "joel-electricien-coupvray-delais-prix",
      title: "Joël à Coupvray : périmètre, délais et engagement tarifaire, sans astérisque",
      body: `Reste la question pratique : qui vient, en combien de temps, pour quel prix.
...
**Pourquoi ce fonctionnement me convient.** J'ai passé ma carrière à reconstituer après coup des litiges qui n'auraient jamais existé si le prix avait été écrit avant. Un tarif fixe annoncé en amont supprime mécaniquement la zone grise où prospèrent les abus — c'est aussi simple que cela. Le **01 41 69 10 08** répond 24h/24. Enregistrez-le avant la panne : c'est le seul conseil de cette page qui ne coûte rien et qui change tout le déroulé du jour J.`,
  ...
  vraisPrix: [
    {
      service: "Diagnostic panne électrique (coupure totale ou partielle)",
      prixJoel: 89,
    ...
    {
      service: "Recherche de court-circuit, circuit par circuit, avec rapport",
      prixJoel: 149,
      prixArnaqueur: "49€ annoncé → 480-1 100€ facturé",
      pourquoi:
    ...
    {
      service: "Remplacement d'un disjoncteur ou différentiel défaillant",
      prixJoel: 119,
      prixArnaqueur: "59€ annoncé → 400-800€ facturé",
      pourquoi:
    ...
    {
      service: "Mise en sécurité d'un tableau vétuste (bâti ancien du village)",
      prixJoel: 179,
      prixArnaqueur: "« devis sur place » → 1 500-4 000€ facturés",
      pourquoi:
    ...
    },
    {
      ...
      prixJoel: 89,
      prixArnaqueur: "« majoration urgence » → 600-1 200€ facturés",
      pourquoi:
  ...
  faqLocale: [
    {
      question:
        "La coupure vient-elle de chez moi ou du réseau ? Comment trancher en deux minutes à Coupvray ?",
      answer:
    ...
    {
      question:
        "Ma maison du vieux village a encore des fusibles à porcelaine : c'est dangereux ?",
      answer:
        "Pas nécessairement dangereux, mais clairement obsolète : pas de différentiel 30 mA, calibrage approximatif, aucune protection des personnes contre les fuites de courant. Le baromètre ONSE 2024 relève au moins une anomalie sur 82,6 % des installations de plus de 15 ans — le bâti briard de Coupvray en fait partie. La démarche raisonnée : un diagnostic à 89€ TTC qui hiérarchise l'urgent (mise en sécurité dès 179€) et le souhaitable, sans jamais vous vendre un tableau complet sous pression.",
    },
    {
      question:
        "J'habite une résidence neuve des Trois Ormes : qui paie la réparation, moi ou le promoteur ?",
      answer:
        "Si la résidence a moins d'un an, la garantie de parfait achèvement couvre les désordres signalés au promoteur. Jusqu'à dix ans, la garantie décennale peut s'appliquer aux défauts de l'installation elle-même (connectique défaillante, malfaçon de pose). Un appareil électroménager en défaut reste en revanche à votre charge. Le rapport remis avec le diagnostic Joël (89€ TTC) précise l'origine exacte de la panne : c'est la pièce technique qui fait la différence dans un dossier de garantie.",
    },
    {
      question:
        "Un électricien peut-il intervenir la nuit ou un dimanche à Coupvray sans majoration ?",
      answer:
        "Oui. Le réseau Joël couvre Coupvray 24h/24, 7j/7, jours fériés compris, à tarif strictement identique : 89€ TTC le diagnostic de panne, à 2h du matin comme à 14h. Les artisans sont positionnés sur le secteur Marne-la-Vallée – Val d'Europe, à proximité immédiate de la commune : comptez 20 à 35 minutes en conditions normales. Numéro : 01 41 69 10 08, prix ferme annoncé avant le déplacement.",
    },
    {
      question:
        "Orage sur la Brie, courant coupé dans toute la rue : qui appeler en premier ?",
      answer:
        "Personne de payant. Une coupure de secteur après orage relève du gestionnaire de réseau : signalez-la à Enedis via le numéro de dépannage de votre facture ou consultez la carte des coupures en ligne. Méfiez-vous en revanche des visites « spontanées » dans les heures qui suivent : ni Enedis ni un électricien sérieux ne démarchent au porte-à-porte après un incident. Si votre logement reste seul sans courant une fois le réseau rétabli, là — et seulement là — un diagnostic chez vous se justifie.",
    },
    {
      question:
        "Je m'absente plusieurs semaines : comment éviter qu'une panne ne désarme la maison ?",
      answer:
        "Trois mesures, dans l'ordre : 1° vérifiez l'autonomie de la batterie de secours de votre alarme — la plupart tiennent quelques heures, pas un week-end ; 2° inscrivez-vous à l'opération Tranquillité Vacances auprès de la gendarmerie, qui organise des passages pendant votre absence ; 3° demandez à un voisin de confiance de vérifier volets et éclairage après tout orage, et de vous signaler une coupure. Une maison visiblement sans courant plusieurs jours attire l'attention — c'est un constat de 31 ans de procédure, pas une hypothèse.",
    },
  ],
  temoignages: [
    {
      auteur: "Hélène V.",
      quartierOuRue: "vieux village, rue Louis-Braille",
      date: "2026-05-17",
      rating: 5,
      serviceRendered: "Diagnostic panne générale dans une maison briarde",
      texte:
    ...
    {
      auteur: "Mathieu L.",
      quartierOuRue: "Les Trois Ormes, résidence neuve",
      date: "2026-03-02",
      rating: 5,
      serviceRendered: "Différentiel qui déclenchait en boucle",
      texte:
    ...
    {
      auteur: "Karim S.",
      quartierOuRue: "abords du canal de Meaux à Chalifert",
      date: "2026-01-25",
      rating: 4,
      serviceRendered: "Recherche de court-circuit un dimanche soir",
      texte:
  ...
  internalLinks: [
    {
      url: "/electricite",
      anchor: "le détail de nos interventions d'électricité en Île-de-France",
    },
    {
      url: "/electricite/tarifs",
      anchor: "la grille tarifaire Joël, affichée avant intervention",
    },
    {
      url: "/electricien/meaux",
      anchor: "électricien à Meaux : même méthode, mêmes prix fixes",
    },
    {
      url: "/electricien/chelles",
      anchor: "notre page électricien à Chelles",
    },
    {
      url: "/stop-arnaques",
      anchor: "la charte anti-arnaque du réseau Joël",
    },
  ],
  tags: [
    "coupvray",
    ...
    "vieux-village",
    "louis-braille",
    "canal-de-meaux-a-chalifert",
    "nf-c-15-100",
    "onse",
    "enedis",
    "urgence-24h",
    "surete-residentielle",
  ],
};
