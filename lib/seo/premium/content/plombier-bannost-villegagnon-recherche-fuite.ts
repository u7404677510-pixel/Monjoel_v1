...
Sur cette page, je vous montre comment confirmer vous-même la fuite (un test gratuit, dix minutes, montre en main), comment je la localise sans démolir, qui paye quoi entre vous, le syndicat des eaux et l'assurance, et ce que ça coûte vraiment : **149 € TTC, prix annoncé avant l'intervention, 24h/24, sans majoration nuit ni week-end**, au **01 41 69 10 08**. Pas de discours commercial. Du concret.`,
  sections: [
    {
      anchor: "terrain-bannost-villegagnon-fuites-enterrees",
      title: "19,4 km², 83 lieux-dits : pourquoi une fuite ne se cherche pas ici comme en ville",
      body: `Bannost-Villegagnon est née en 1973 de la fusion de deux villages, Bannost et Villegagnon — celui-là même qui a donné son nom à une île de la baie de Rio, par la grâce de l'amiral Nicolas Durand de Villegagnon, parti planter la France au Brésil au XVIe siècle. Aujourd'hui, la commune fait partie de la communauté de communes du Provinois, et son territoire est agricole à plus de 90 % (données INSEE d'occupation des sols). Concrètement, pour mon métier, ça veut dire une chose : de l'habitat dispersé, des parcelles longues, et des réseaux d'eau privés qui n'en finissent pas.
...
Un Compagnon vous dirait la même chose : avant de chercher l'eau, on lit le terrain. C'est exactement pour ça qu'une recherche de fuite à Bannost-Villegagnon ne s'improvise pas avec une pioche et de l'optimisme. On sectorise, on mesure, on écoute — et seulement ensuite, on ouvre. Au bon endroit, et une seule fois.`,
    ...
    {
      anchor: "test-compteur-confirmer-fuite",
      title: "Le test des dix minutes : confirmez la fuite vous-même avant de payer qui que ce soit",
      body: `En 28 ans de métier, j'ai vu passer des dizaines de « fuites » qui n'en étaient pas. Avant de me faire venir — et avant de payer quiconque —, faites ce test. Il est gratuit, il prend dix minutes le soir, et il vous dit déjà la moitié de ce que j'ai besoin de savoir.
...
Si le compteur n'a pas bougé de la nuit, bonne nouvelle : vous n'avez probablement pas besoin de moi, cherchez plutôt côté toiture, condensation ou remontées capillaires — des sujets de couvreur ou de maçon, pas de plombier. Je préfère vous le dire ici plutôt que de facturer une intervention pour rien. Et si le compteur a tourné, appelez le **01 41 69 10 08** avec vos deux relevés : au téléphone, on vous annonce le prix — **149 € TTC** pour la recherche — avant que quiconque ne se déplace.`,
    ...
    {
      anchor: "methode-localisation-non-destructive",
      title: "Localiser sans casser : ce que je sors du camion, et dans quel ordre",
      body: `Une recherche de fuite sérieuse, c'est une méthode, pas un coup de chance. Voici comment je travaille, étape par étape, que ce soit dans une longère du bourg de Bannost ou un pavillon de Villegagnon.
...
L'eau dure ne provoque pas votre fuite du jour au lendemain. Mais elle explique pourquoi, dans une commune comme celle-ci, les installations de 30 ou 40 ans méritent un œil attentif : ballon, groupe de sécurité, raccords laiton, anciens tubes encastrés. Quand l'un d'eux lâche en silence, la recherche de fuite à **149 € TTC** coûte toujours moins cher que six mois de mètres cubes envolés.`,
    ...
    {
      anchor: "qui-paye-compteur-warsmann-assurance",
      title: "Avant compteur, après compteur, loi Warsmann : la mécanique de qui paye quoi",
      body: `Une fuite confirmée, c'est deux questions : où est-elle, et qui paye. La seconde dépend presque entièrement de la première. Voici la mécanique, telle que je l'explique à mes clients du Provinois.
...
Mon conseil, après des centaines de dossiers : **documentez tout, dans l'ordre**. Photo du compteur au début, photo à la fin, compte rendu de recherche, facture de réparation, attestation. Avec ce dossier complet, j'ai vu des factures d'eau divisées par deux ou trois, et des recherches de fuite intégralement remboursées par l'assurance. Sans dossier, j'ai vu l'inverse.`,
    ...
    {
      anchor: "prix-fixe-anti-arnaque-provinois",
      title: "149 € annoncé avant, 0 majoration : ma façon de travailler — et les pièges du dépannage en zone rurale",
      body: `Je termine par ce qui fâche, parce qu'il faut en parler. Les campagnes du Provinois ne sont pas épargnées par les dérives du dépannage — elles sont même une cible commode : pas de concurrent au coin de la rue, des propriétaires âgés parfois isolés dans les hameaux, et l'angoisse de l'eau qui file. Les schémas que je vois revenir, de Bannost-Villegagnon à Jouy-le-Châtel :
...
Un Compagnon apprend une chose en premier sur le tour de France : on annonce ce qu'on va faire, on fait ce qu'on a annoncé. Le prix, c'est pareil.`,
  ...
  vraisPrix: [
    {
      service: "Recherche de fuite non destructive (caméra thermique, gaz traceur, écoute)",
      prixJoel: 149,
      prixArnaqueur: "59€ annoncé → 600-1400€ facturé",
      pourquoi:
    ...
    {
      service: "Recherche de fuite sur réseau enterré long (corps de ferme, tronçon compteur-maison)",
      prixJoel: 249,
      prixArnaqueur: "« devis sur place » → 900-2500€ facturé",
      pourquoi:
    ...
    {
      service: "Réparation de la fuite localisée (tronçon ou raccord accessible)",
      prixJoel: 89,
      prixArnaqueur: "49€ annoncé → 400-900€ facturé",
      pourquoi:
    ...
    {
      service: "Recherche de fuite + rapport détaillé pour assurance (dégât des eaux)",
      prixJoel: 199,
      prixArnaqueur: "79€ annoncé → 700-1600€ facturé",
      pourquoi:
  ...
  faqLocale: [
    {
      question:
        "Mon compteur tourne alors que tout est fermé dans ma maison de Marchelong : c'est forcément une fuite ?",
      answer:
    ...
    {
      question:
        "La recherche de fuite va-t-elle casser ma dalle ou mes murs en moellons ?",
      answer:
        "Non, c'est tout l'intérêt de la méthode. On localise d'abord — sectorisation, caméra thermique, gaz traceur, écoute électroacoustique — et on marque le point au sol à 20-30 cm près. L'ouverture, si elle est nécessaire pour réparer, est ciblée et unique. Dans les longères briardes aux murs épais, la thermique a ses limites, mais le gaz traceur prend le relais. Fuyez quiconque propose de « casser pour voir » : une recherche digne de ce nom précède toujours la démolition.",
    },
    {
      question:
        "Ma facture d'eau S2E77/Veolia a doublé à cause d'une fuite : puis-je obtenir un dégrèvement ?",
      answer:
        "Oui, dans les conditions de la loi Warsmann : résidence principale, fuite sur canalisation après compteur (hors chasse d'eau, ballon et appareils), et consommation supérieure au double de votre moyenne habituelle. Il faut faire réparer par un professionnel et transmettre une attestation de réparation (localisation + date) dans le mois suivant l'information du service des eaux. Le compte rendu remis après la recherche Joël sert exactement à ça. Sans ce dossier, vous payez la totalité des mètres cubes perdus.",
    },
    {
      question:
        "Un artisan peut-il vraiment intervenir vite à Bannost-Villegagnon, jusqu'aux Essarts ou à la Conquillie ?",
      answer:
        "Oui. Les artisans du réseau Joël couvrent le secteur entre Provins et Coulommiers, et la commune est à quelques minutes de Jouy-le-Châtel par les départementales. Comptez en général 30 à 45 minutes pour rejoindre le bourg de Bannost, Villegagnon ou les écarts, 24h/24, dimanches et jours fériés compris — sans aucune majoration. Le tarif annoncé au téléphone (149€ TTC pour une recherche de fuite) est le même à 3h du matin qu'en pleine journée. Numéro : 01 41 69 10 08.",
    },
    {
      question:
        "L'eau de la commune est très calcaire : peut-elle vraiment provoquer des fuites ?",
      answer:
        "Le contrôle sanitaire a relevé 26,53 °f en février 2026 sur le réseau de Jouy-le-Châtel qui alimente la commune : une eau dure, typique de la Brie. Le calcaire ne perce pas un tube du jour au lendemain, mais il bloque les groupes de sécurité (qui se mettent à couler en continu — la fausse fuite la plus courante ici), entartre les ballons, raidit joints et robinetteries, et favorise des corrosions par piqûres sous les dépôts irréguliers, notamment sur le cuivre encastré. Sur une installation de 30-40 ans, c'est souvent là que je trouve la perte.",
    },
    {
      question:
        "La fuite est entre mon compteur en bord de route et ma maison : qui paye la réparation ?",
      answer:
        "Tout ce qui est en aval du compteur est privé : recherche et réparation sont à la charge du propriétaire, même si le tube passe sous votre cour ou votre jardin. En amont du compteur (branchement, regard, compteur), c'est le service de l'eau — signalez-le à l'exploitant, vous n'avez rien à payer. Bonne nouvelle côté budget : la loi Warsmann permet d'écrêter la facture d'eau, et beaucoup d'assurances habitation remboursent les frais de recherche sur sinistre déclaré. Documentez tout : photos du compteur, compte rendu, facture.",
    },
  ],
  temoignages: [
    {
      auteur: "Gérard L.",
      quartierOuRue: "hameau des Essarts",
      date: "2026-03-17",
      rating: 5,
      serviceRendered: "Recherche de fuite au gaz traceur sur réseau enterré",
      texte:
    ...
    {
      auteur: "Sandrine P.",
      quartierOuRue: "bourg de Villegagnon",
      date: "2026-01-24",
      rating: 5,
      serviceRendered: "Recherche de fuite + remplacement groupe de sécurité entartré",
      texte:
    ...
    {
      auteur: "Mathieu R.",
      quartierOuRue: "bourg de Bannost, près de l'église",
      date: "2026-05-06",
      rating: 4,
      serviceRendered: "Localisation de fuite encastrée à la caméra thermique",
      texte:
  ...
  internalLinks: [
    {
      url: "/plomberie",
      anchor: "tous nos services de plomberie en Seine-et-Marne",
    },
    {
      url: "/plombier/fuite-eau",
      anchor: "réparation de fuite d'eau en urgence, prix annoncé avant",
    },
    {
      url: "/plombier/provins/debouchage-canalisation",
      anchor: "notre intervention plomberie à Provins (débouchage de canalisation)",
    },
    {
      url: "/plombier/la-ferte-gaucher/debouchage-canalisation",
      anchor: "plombier à La Ferté-Gaucher : débouchage et canalisations",
    },
    {
      url: "/stop-arnaques",
      anchor: "notre charte anti-arnaque et nos engagements de prix",
    },
  ],
  tags: [
    "bannost-villegagnon",
