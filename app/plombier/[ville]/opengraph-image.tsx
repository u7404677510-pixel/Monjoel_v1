/**
 * OG image dynamique par ville — route /plombier/[ville].
 *
 ...
 *
 * URL générée : https://monjoel.fr/plombier/{ville-slug}/opengraph-image
 *
 * DA Purple stricte (palette joel-violet/mauve/yellow), sync avec
 * app/plomberie/opengraph-image.tsx — seuls les éléments contextuels
 * (nom de ville + département) varient.
 *
...
export const alt = "Joël - Plombier urgence Île-de-France · Prix fixe dès 79€";
...
/**
 * Fallback si le slug n'est pas trouvé dans la base citiesIDF :
 * "paris-15" -> "Paris 15", "boulogne-billancourt" -> "Boulogne Billancourt".
 */
...
export default async function Image({
  ...
  // Si nom de ville long (>14 chars), réduire la taille pour éviter overflow.
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              Intervention 30 min · Prix fixe dès 79€
            </div>
          </div>

          {/* Pied — département + téléphone */}
          <div
            style={{
              display: "flex",
              alignItems: "center",
