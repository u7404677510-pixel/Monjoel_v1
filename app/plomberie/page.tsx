...
export const metadata: Metadata = {
  ...
  description: "Plombier d'urgence Paris & IDF ⭐ 4.9/5 (947 avis). Fuite, WC, chauffe-eau. Intervention 20 min, à partir de 79€. Sans majoration. 01 41 69 10 08",
  keywords: [
  ...
  openGraph: {
    ...
    siteName: "Joël",
    title: "Plombier d'urgence Paris | Dès 79€ | Intervention 20 min",
    description: "Plombier d'urgence à partir de 79€. Intervention en 20 min, zéro arnaque. Appelez le 01 41 69 10 08.",
    images: [
      {
        url: "/og-default.jpg",
        width: 1200,
  ...
  twitter: {
    ...
    title: "Plombier d'urgence Paris | Dès 79€ | Intervention 20 min",
    description: "Plombier d'urgence à partir de 79€. Intervention en 20 min. Appelez le 01 41 69 10 08.",
...
const hubFaqItems = [
  ...
  },
  {
    ...
    answer:
      "Nos plombiers interviennent en 20 minutes en moyenne sur Paris et l'Île-de-France. Dès que vous appelez, nous identifions l'artisan le plus proche de chez vous.",
  },
  {
    question:
