...
import { FileText, Image, Settings, Search, Phone, Users, UserPlus } from "lucide-react";
...
const quickActions = [
  ...
  { href: "/admin/recrutement", label: "Recrutement", icon: UserPlus, color: "bg-joel-yellow", description: "Candidatures artisans", priority: true },
