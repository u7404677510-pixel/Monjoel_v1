...
export default function CityFAQ({ faqItems, cityName, tradeName }: CityFAQProps) {
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            {tradeName} à {cityName} : vos questions
          </h2>
          <p className="text-gray-600">
            Retrouvez les réponses aux questions les plus fréquentes sur nos interventions.
          </p>
        </motion.div>
