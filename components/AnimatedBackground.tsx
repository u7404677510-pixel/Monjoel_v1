export default function AnimatedBackground() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      {/* Static violet blobs */}
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-linear-to-br from-joel-violet/20 to-joel-mauve/10 rounded-full blur-3xl" />
      
      <div className="absolute top-1/3 -left-40 w-80 h-80 bg-linear-to-br from-joel-mauve/15 to-joel-violet/10 rounded-full blur-3xl" />
      
      <div className="absolute bottom-20 right-1/4 w-64 h-64 bg-linear-to-br from-joel-violet/10 to-joel-mauve/15 rounded-full blur-3xl" />
