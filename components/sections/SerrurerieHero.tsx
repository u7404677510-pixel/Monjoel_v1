...
import { Key, Phone, Star, MapPin, Clock, Shield, BadgeCheck, Users, ArrowRight, Award } from "lucide-react";
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-0.5">
                      ...
                      <span className="text-[10px] text-gray-500 ml-1">A2P certifié</span>
                    </div>
                  </div>
                </div>
              </motion.div>
