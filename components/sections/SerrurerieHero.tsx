...
import { Key, Phone, Star, MapPin, Clock, Shield, BadgeCheck, Users, ArrowRight } from "lucide-react";
...
export default function SerrurerieHero({ title, subtitle, description }: SerrurerieHeroProps) {
  ...
  return (
    <section className="relative min-h-[100svh] lg:min-h-screen flex items-center pt-20 lg:pt-20 overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 lg:hidden hero-bg-serrurerie opacity-15">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-8 items-center">
          ...
          <div className="order-1">
            ...
            >
              ...
              <Users size={14} />
              <span>{artisansCount} serruriers disponibles maintenant</span>
            </div>
            {/* Badge métier */}
            <div
            ...
            <div className="hidden lg:block border-t border-gray-100 pt-6">
              <p className="text-xs text-gray-500 uppercase tracking-wide mb-3">Marques partenaires</p>
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div className="flex items-center gap-2 text-gray-600 bg-white border border-gray-200 px-3 py-2 rounded-lg">
                  <BadgeCheck size={16} className="text-joel-violet" />
                  <span className="text-sm font-medium">Fichet</span>
                </div>
                <div className="flex items-center gap-2 text-gray-600 bg-white border border-gray-200 px-3 py-2 rounded-lg">
                  <BadgeCheck size={16} className="text-joel-violet" />
                  <span className="text-sm font-medium">Bricard</span>
                </div>
                <div className="flex items-center gap-2 text-gray-600 bg-white border border-gray-200 px-3 py-2 rounded-lg">
            ...
            <div className="relative max-w-lg mx-auto lg:max-w-none">
              ...
              <div className="relative rounded-3xl overflow-hidden">
                <Image
                  ...
                  alt="Serrurier professionnel - Dépannage serrurerie Paris Île-de-France"
                  width={600}
                  height={600}
