...
const services = [
  {
    href: "/plombier/fuite-eau",
    icon: Droplets,
    title: "Fuite d'eau",
    description: "Intervention immédiate pour stopper la fuite. Réparation durable.",
    price: "89€",
    highlight: true,
  },
  {
    href: "/plombier/wc-bouches",
    icon: ShowerHead,
    title: "WC bouchés",
    description: "Débouchage rapide et efficace. Canalisations dégagées.",
    price: "79€",
    highlight: false,
  },
  {
    href: "/plombier/degat-des-eaux",
    icon: Waves,
    title: "Dégât des eaux",
    description: "Recherche de fuite + réparation. Attestation assurance fournie.",
    price: "129€",
    highlight: false,
  },
  {
    href: "/plombier/chauffe-eau-panne",
    icon: Flame,
    title: "Chauffe-eau en panne",
    description: "Diagnostic + réparation express. Plus d'eau froide.",
    price: "99€",
    highlight: false,
  },
  {
    href: "/plombier/remplacement-robinet",
    icon: Wrench,
    title: "Remplacement robinet",
    description: "Robinet ou siphon remplacé. Prix fixe tout compris.",
    price: "69€",
    highlight: false,
  },
];

export default function PlomberieServicesGrid() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
            Nos interventions <span className="gradient-text">plomberie</span>
          </h2>
