    ...
    <section ref={ref} className="py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-joel-yellow/20 rounded-full blur-2xl" />

          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
            {/* Icon */}
            <div className="w-24 h-24 bg-joel-yellow/30 rounded-3xl flex items-center justify-center flex-shrink-0">
