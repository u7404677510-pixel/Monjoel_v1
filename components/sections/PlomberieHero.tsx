...
interface PlomberieHeroProps {
  title: string;
  subtitle: string;
  description: string;
  servicePrice?: string;
}
export default function PlomberieHero({ title, subtitle, description, servicePrice }: PlomberieHeroProps) {
          ...
          <div className="order-1">
            ...
            <div className="hidden lg:block border-t border-gray-100 pt-6">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div className="flex items-center gap-2 text-gray-600 bg-white border border-gray-200 px-3 py-2 rounded-lg">
                  <BadgeCheck size={16} className="text-joel-violet" />
                  <span className="text-sm font-medium">Hansgrohe</span>
                </div>
                <div className="flex items-center gap-2 text-gray-600 bg-white border border-gray-200 px-3 py-2 rounded-lg">
                  <BadgeCheck size={16} className="text-joel-violet" />
